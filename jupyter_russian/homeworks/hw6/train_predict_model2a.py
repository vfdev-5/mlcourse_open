...
vectorizer = TfidfVectorizer(max_features=1500000, ngram_range=(1, 3), tokenizer=tokenizer)
...
print("- CV model")
log_reg_cv = LogisticRegressionCV(Cs=Cs, cv=skf, scoring='roc_auc', random_state=42, verbose=True, n_jobs=-1)
log_reg_cv.fit(X, y)
...
write_to_submission_file(test_probas, "assignment6_alice_submission_model2a_FN={}_FP={}_TP={}.csv"
