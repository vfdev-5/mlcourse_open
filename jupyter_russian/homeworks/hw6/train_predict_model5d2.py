...
def compute_timebased_features(df):
    ...
    features = ['session_duration', 'is_weekend']
    return pd.concat([df[features], res1, res2], axis=1)
...
write_to_submission_file(test_probas, "assignment6_alice_submission_model5d2_roc_auc={:.4f}_FN={}_FP={}_TP={}.csv"
