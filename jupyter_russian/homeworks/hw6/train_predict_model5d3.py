...
n_splits = 7
max_train_size = None
vectorizer = TfidfVectorizer(max_features=5000000, ngram_range=(1, 6))
...
write_to_submission_file(test_probas, "assignment6_alice_submission_model5d3_roc_auc={:.4f}_FN={}_FP={}_TP={}.csv"
