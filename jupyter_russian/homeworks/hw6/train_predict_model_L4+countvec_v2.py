...
vectorizer = CountVectorizer(ngram_range=(1, 4), max_features=1000000)
...
score = np.max(score)
write_to_submission_file(y_test, "assignment6_alice_submission_model_L4+countvec_v2_roc_auc={:.4f}_FN={}_FP={}_TP={}.csv"
