...
log_reg = LogisticRegression(penalty='l2', solver=solver, class_weight=class_weight,
...
write_to_submission_file(test_probas, "assignment6_alice_submission_model7a_FN={}_FP={}_TP={}.csv"
