...
def compute_timebased_features(df):
    ...
    res = pd.get_dummies(df['daytime1'])
    ...
    return pd.concat([df[features], res], axis=1)
...
write_to_submission_file(test_probas, "assignment6_alice_submission_model5b_FN={}_FP={}_TP={}.csv"
