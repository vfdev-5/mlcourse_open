...
log_reg.fit(X, y)
model = SelectFromModel(log_reg, threshold="0.5*mean", prefit=True)
...
write_to_submission_file(test_probas, "assignment6_alice_submission_model9_roc_auc={:.4f}_FN={}_FP={}_TP={}.csv"
