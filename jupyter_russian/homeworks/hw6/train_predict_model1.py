...
vectorizer = TfidfVectorizer(max_features=1500000, ngram_range=(1, 3))
...
write_to_submission_file(test_probas, "assignment6_alice_submission_model1_FN={}_FP={}_TP={}.csv"
