...
n_splits = 7
max_train_size = None
vectorizer = CountVectorizer(max_features=5000000, ngram_range=(1, 3))
...
X = add_timebased_features(train_sites_cvec, train_df)
print(X.shape)
...
print("- Predictions")
X_test = add_timebased_features(test_sites_cvec, test_df)
...
write_to_submission_file(test_probas, "assignment6_alice_submission_model5d4_roc_auc={:.4f}_FN={}_FP={}_TP={}.csv"
