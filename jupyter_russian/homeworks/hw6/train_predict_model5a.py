...
vectorizer = TfidfVectorizer(max_features=7000000, ngram_range=(1, 5), tokenizer=tokenizer)
...
write_to_submission_file(test_probas, "assignment6_alice_submission_model5a_FN={}_FP={}_TP={}.csv"
