...
max_train_size = None
n_splits = 5
vectorizer = TfidfVectorizer(max_features=5000000, ngram_range=(1, 5), tokenizer=tokenizer)
...
log_reg.fit(X, y)
model = SelectFromModel(log_reg, threshold="mean", prefit=True)
...
write_to_submission_file(test_probas, "assignment6_alice_submission_model9a_roc_auc={:.4f}_FN={}_FP={}_TP={}.csv"
